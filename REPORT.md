...
üretim zamanı : 2026-09-02T22:29:37.784074Z
lead time     : 24 saat (hedef günün yerel başlangıcından önce)
========================================================================

## Veri
  piyasa snapshot           8598
  orderbook seviyesi      476513
  tahmin snapshot           6930
  karar                     1602
  simüle fill                409
...
## İşlemler (354)
  işlem sayısı                     354
  kazanan                          118  (%33)
  ort. İDDİA EDİLEN edge       +13.18p   (beklenen değer)
  ort. GERÇEKLEŞEN edge         -2.80p   ±2.1p  %95 [-6.9p, +1.3p]
     -> iddia edilen değer aralığın DIŞINDA: model sistematik
        olarak yanlış kalibre veya hesapta sorun var.
  toplam fee                    408.05 $
  PnL fee ÖNCESİ               +184.67 $
  PnL fee SONRASI              -223.38 $
